...
import { fetchTrending, postSearch, fetchCategories, type RecItem } from "../lib/api";
import ArticleCard from "../components/ArticleCard";
import { useState } from "react";
import { motion } from 'framer-motion';
import { FiSearch, FiTrendingUp, FiArrowLeft } from 'react-icons/fi';
import {
  GlassCard,
  FormContainer,
  SearchContainer,
      ...
      >
        <FormContainer style={{ textAlign: 'center', padding: '3rem 2rem' }}>
          <SectionHeader>
            ...
            <SectionSubtitle style={{ fontSize: '1.25rem', marginBottom: '2rem' }}>
            ...
            <div style={{ 
              ...
              {['sports', 'health', 'politics', 'technology', 'entertainment'].map(tag => (
                <button
                  ...
                  style={{
                    padding: '0.5rem 1rem',
                    background: selectedCategory === tag ? 'rgba(255, 255, 255, 0.2)' : 'rgba(255, 255, 255, 0.1)',
                    border: '1px solid rgba(255, 255, 255, 0.2)',
                    borderRadius: '20px',
                    color: 'white',
                    fontSize: '0.875rem',
                  ...
                  onMouseLeave={e => {
                    e.currentTarget.style.background = selectedCategory === tag ? 'rgba(255, 255, 255, 0.2)' : 'rgba(255, 255, 255, 0.1)';
        ...
        <FormContainer>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2rem' }}>
            <SectionHeader style={{ textAlign: 'left', margin: 0 }}>
              <SectionTitle style={{ fontSize: '2rem', marginBottom: '0.5rem', display: 'flex', alignItems: 'center' }}>
            ...
            <>
              {items.length > 0 ? (
                ...
                <EmptyStateContainer>
                  ...
                  <EmptyStateTitle>
                    {isSearchActive ? "No articles found" : "No trending articles"}
                  </EmptyStateTitle>
                  <EmptyStateMessage>
                    {isSearchActive ? "Try different keywords or browse trending stories." : "Check back later for the latest trends."}
                  </EmptyStateMessage>
                </EmptyStateContainer>
              )}
            </>
